        ...
        <div class="row">
            ...
            <div class="col-sm-12 blog-left">
                <ul class="blog-listing detail">
                    <li> <img src="{{url('public/upload/department/',$item->image) }}" class="img-responsive" alt="">
                        <h2>{{$item->name}}</h2>
                        <ul class="post-detail">
                            <li><span class="icon-calander-icon ico"></span><span class="bold">{{$item->created_at}}</li>
