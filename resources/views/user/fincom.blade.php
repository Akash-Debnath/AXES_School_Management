...
<!-- ==============================================
    ** Browse Teacher **
    ...
    <section class="browse-teacher grey-bg padding-lg">
        <div class="container">
            <h2><span>Our Honourable</span> Finance Committee</h2>
            <ul class="row browse-teachers-list clearfix">
                @foreach($allData as $key => $value )
                    <li class="col-xs-6 col-sm-3">
                        <figure> 
                            <img src="{{ ($value->image)? url('public/upload/fincom/'.$value->image):url('upload/no_image.jpg') }}"width="123" height="124" alt=""> 
                             </figure>
                        <h3>{{ $value->name }}</h3>
...
<!--@section('user')-->
  ...
  <!-- ==============================================
<!--    ** Browse Financial Committee **-->
<!--    =================================================== -->-->
<!--    <section class="browse-teacher padding-lg">-->
<!--        <div class="container">-->
<!--            <h2><span></span> Finance Committee </h2>-->
<!--            <ul class="row browse-teachers-list clearfix">-->
<!--                <li class="col-xs-6 col-sm-3">-->
<!--                    <figure> <img src="images/teacher1.jpg" width="124" height="124" alt=""> </figure>-->
...
<!--                </li>-->
<!--                <li class="col-xs-6 col-sm-3">-->
<!--                    <figure> <img src="images/teacher2.jpg" width="123" height="124" alt=""> </figure>-->
