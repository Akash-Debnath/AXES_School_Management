...
<!-- ==============================================
    ** Browse Teacher **
    ...
    <section class="browse-teacher grey-bg padding-lg">
        <div class="container">
            <h2><span>Our Honourable</span> Syndicate</h2>
            <ul class="row browse-teachers-list clearfix">
                @foreach($allData as $key => $value )
                    <li class="col-xs-6 col-sm-3">
                        <figure> 
                            <img src="{{ ($value->image)? url('public/upload/syndicate/'.$value->image):url('upload/no_image.jpg') }}"width="123" height="124" alt=""> 
                             </figure>
                        <h3>{{ $value->name }}</h3>
...
<!--        <div class="container">-->
<!--            <h2><span></span> Syndicate </h2>-->
<!--                 <ul class="row browse-teachers-list clearfix">-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member1.jpg" alt="" width="123" height="124"> </figure>-->
...
<!--                    </li>-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member2.jpg" alt=" " width="123" height="124"> </figure>-->
<!--                        <h3>Professor Dr. Mohammad Johurul Islam  </h3>-->
<!--                        <span class="designation">Member</span>-->
<!--                        <p><br>Department of Law, Islamic University, Kushtia-->

<!--                           <br>Nominee, Academic Council </p>-->
<!--                        <ul class="teachers-follow">-->
<!--                            <li><a href="#"><i class="fa fa-twitter" aria-hidden="true"></i></a></li>-->
<!--                            <li><a href="#"><i class="fa fa-linkedin" aria-hidden="true"></i></a></li>-->
<!--                            <li><a href="#"><i class="fa fa-skype" aria-hidden="true"></i></a></li>-->
...
<!--                    </li>-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member3.jpg" alt=" " width="123" height="124"> </figure>-->
<!--                        <h3>Professor Dr. Md. Shahidur Rahman</h3>-->
<!--                        <span class="designation">Member</span>-->
<!--                        <p><br>Dean, Faculty of Arts and Social Sciences-->
...
<!--                    </li>-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member4.jpg" alt=" " width="123" height="124"> </figure>-->
<!--                        <h3>Professor Md. Iqbal Hossain</h3>-->
<!--                        <span class="designation">Member</span>-->
<!--                        <p><br>Head, Department of English-->
...
<!--                <ul class="row browse-teachers-list clearfix">-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member5.jpg" alt="" width="123" height="124"> </figure>-->
<!--                        <h3> Mr. Hasanul Haq Inu, MP</h3>-->
<!--                        <span class="designation">Member</span>-->
<!--                        <p><br>Chairman, Board of Trustees-->
...
<!--                    </li>-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member6.jpg" alt="" width="123" height="124"> </figure>-->
<!--                        <h3>Mrs. Afroza Haq</h3>-->
<!--                        <span class="designation"> Member</span>-->
<!--                        <p><br>Board of Trustees-->
...
<!--                    </li>-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member7.jpg" alt="" width="123" height="124"> </figure>-->
<!--                        <h3>Mr. Muh. Shamsur Rahman Babu</h3>-->
<!--                        <span class="designation">Member</span>-->
<!--                        <p><br>Member Secretary, Board of Trustees-->
...
<!--                    </li>-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member8.jpg" alt="" width="123" height="124"> </figure>-->
<!--                        <h3>Professor Dr. Md. Shahinoor Rahman</h3>-->
<!--                        <span class="designation">Member</span>-->
<!--                        <p><br>Pro-Vice Chancellor-->
...
<!--                <ul class="row browse-teachers-list clearfix">-->
<!--                    <li class="col-xs-6 col-sm-3">-->
<!--                        <figure> <img src="public/themefronted/images/syndicate/syndicate_member9.jpg" alt="" width="123" height="124"> </figure>-->
