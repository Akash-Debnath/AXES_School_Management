        ...
        <div class="container">
            <ul class="row news-listing">
                ...
                <li class="col-xs-6 col-sm-4 grid-item">
                    <div class="inner"> <img src="{{url('public/upload/newsevent/',$item->image) }}" class="img-responsive" alt="">
                        <div class="cnt-block">
                            ...
                            <h2>{{$item->title}}</h2>
                            <a href="{{route('newsdetails',$item->id)}}" class="read-more"><span class="icon-play-icon"></span>Read More</a>
                        </div>
                    </div>
                </li>
