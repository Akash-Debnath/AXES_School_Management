        ...
        <section class="sidebar">
            ...
            <ul class="sidebar-menu" data-widget="tree">
                ...
                <li class="treeview {{ ($prefix == '/students')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        <li><a href="{{ route('student.registration.view') }}"><i class="ti-more"></i>Students</a></li>
                ...
                <!--      </li>-->
                 ...
                 <li class="treeview {{ ($prefix == '/students')?'active':'' }}">
                    ...
                    <a href="#">
                        <i data-feather="credit-card"></i> <span>Front Office</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-right pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'postaldispatch.view')?'active':'' }}"><a href="{{ route('postaldispatch.view') }}"><i class="ti-more"></i>Postal Dispatch</a></li>
                        <li class="{{ ($route == 'postalreceive.view')?'active':'' }}"><a href="{{ route('postalreceive.view') }}"><i class="ti-more"></i>Postal Receive</a></li>
                        <li class="{{ ($route == 'complain.view')?'active':'' }}"><a href="{{ route('complain.view') }}"><i class="ti-more"></i>Complain</a></li>
                        <li class="{{ ($route == 'setupfrontoffice.view')?'active':'' }}"><a href="{{ route('setupfrontoffice.view') }}"><i class="ti-more"></i>Setup Front Office</a></li>
                ...
                <li class="treeview {{ ($prefix == '/inventory')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'inventory.issueitem.view')?'active':'' }}"><a href="{{route('inventory.issueitem.view')}}"><i class="ti-more"></i>Issue Item</a></li>
                        <li class="{{ ($route == 'inventory.additemstock.view')?'active':'' }}"><a href="{{ route('inventory.additemstock.view') }}"><i class="ti-more"></i>Add Item Stock</a></li>
               ...
               <li class="treeview {{ ($prefix == '/attendance')?'active':'' }}">
                ...
                <li class="treeview {{ ($prefix == '/content')?'active':'' }}">
                    <a href="#">
                        <i data-feather="edit-2"></i> <span> Download center </span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-right pull-right"></i>
                        </span>
                    </a>
                ...
                <li class="treeview {{ ($prefix == '/library')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'library.issuereturn.index')?'active':'' }}"><a href="{{ route('library.issuereturn.index') }}"><i class="ti-more"></i>Issue Return</a></li>
                 ...
                 <li class="treeview {{ ($prefix == '/hostel')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ ($route == 'hostel.hosteldetail.view')?'active':'' }}"><a href="{{ route('hostel.hosteldetail.view') }}"><i class="ti-more"></i>Hostel</a></li>
                ...
                <li class="treeview {{ ($prefix == '/accounts')?'active':'' }}">
                    <a href="#">
                        <i data-feather="edit-2"></i> <span>Accounts Setup</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-right pull-right"></i>
                        </span>
                    </a>
                    <ul class="treeview-menu">
                        ...
                        <li class=""><a href="#"><i class="ti-more"></i>Trial Blance</a></li>
                        <li class=""><a href="#"><i class="ti-more"></i>Blance Sheet</a></li>
                        <li class=""><a href="#"><i class="ti-more"></i>Blance Sheet</a></li>
                ...
                <li class="treeview {{ ($prefix == '/examination')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class=""><a href=""><i class="ti-more"></i>Exam Group</a></li>
                        <li><a href="{{ route('exam.type.view') }}"><i class="ti-more"></i>Exam Type</a></li>
                        <li class=""><a href=""><i class="ti-more"></i>Exam Schedule</a></li>
                        <li class=""><a href=""><i class="ti-more"></i>Exam Result</a></li>
                        <li class=""><a href=""><i class="ti-more"></i>Design Admit Card</a></li>
                        <li class=""><a href=""><i class="ti-more"></i>Print Admit Card</a></li>
                        <li class=""><a href=""><i class="ti-more"></i>Design Marketsheet </a></li>
                        <li class=""><a href=""><i class="ti-more"></i>Print Marketsheet </a></li>
                        <li class="{{ ($route == 'marks.entry.add')?'active':'' }}"><a href="{{ route('marks.entry.add') }}"><i class="ti-more"></i>Marks Entry</a></li> 
                    <li class="{{ ($route == 'marks.entry.edit')?'active':'' }}"><a href="{{ route('marks.entry.edit') }}"><i class="ti-more"></i>Marks Edit</a></li>
                ...
                <li class="treeview {{ ($prefix == '/humanresource')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        {{-- <li class=""><a href="#"><i class="ti-more"></i>Department List</a></li> --}}
                        {{-- <li class=""><a href="#"><i class="ti-more"></i> Department</a></li> --}}
                        <li><a href="{{ route('employee.department.view') }}"><i class="ti-more"></i>Employee Department </a></li>
                        {{-- <li class=""><a href="#"><i class="ti-more"></i>Designation List</a></li> --}}
                        {{-- <li class=""><a href="#"><i class="ti-more"></i>Designation</a></li> --}}
                        <li><a href="{{ route('employee.designation.view') }}"><i class="ti-more"></i>Employee  Designation </a></li>
                        {{-- <li class=""><a href="#"><i class="ti-more"></i>Employee List</a></li> --}}
                        ...
                        {{-- <li class=""><a href="#"><i class="ti-more"></i>Add Employee</a></li> --}}
                        <li class=""><a href="{{ route('employee.leavetype.view') }}"><i class="ti-more"></i>Leave Type</a></li>
                        {{-- <li class=""><a href="#"><i class="ti-more"></i>Add Leave Type</a></li> --}}
                        <li class=""><a href="#"><i class="ti-more"></i>Leave Record</a></li>
                        <li class=""><a href="#"><i class="ti-more"></i>Add Leave Application</a></li>
                        <li class=""><a href="#"><i class="ti-more"></i>Add Salary</a></li>
                        <li class=""><a href="#"><i class="ti-more"></i>Salary sheet & Payslip </a></li>
                ...
                <!--</li>-->
                 <li class="treeview {{ ($prefix == '/academics')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        <li class="{{ ($route == 'classtimetable.view')?'active':'' }}"><a href="{{ route('classtimetable.view') }}"><i class="ti-more"></i>Class Timetable</a></li>
                 ...
                 <li class="treeview {{ ($prefix == '/report')?'active':'' }}">
                    <a href="#">
                        <i data-feather="edit-2"></i> <span> Report</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-right pull-right"></i>
                        </span>
                    </a>
                ...
                <li class="treeview {{ ($prefix == '/notice')?'active':'' }}">
                    ...
                    <ul class="treeview-menu">
                        ...
                        <li class="{{ ($route == 'notice.viewlist')?'active':'' }}"><a href="{{ route('notice.viewlist') }}"><i class="ti-more"></i>Notice List</a></li>
                ...
                <li class="treeview {{ ($prefix == '/webmenagement')?'active':'' }}">
                    <a href="#">
                        <i data-feather="edit-2"></i> <span>Web Menagement</span>
                        <span class="pull-right-container">
                            <i class="fa fa-angle-right pull-right"></i>
                        </span>
                    </a>
