                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="box ">
                                    <div class="box-body text-center">
                                        <img  src="https://www.bdsoft.org/uploads/school_content/logo/1.png" class="img-thumbnail" alt="Cinque Terre" width="304" height="236">
                                    </div>
                                    <div class="row">

                                        <label for="" class="box col-md-4">Print Logo :</label>
                                        <div class="box col-md-8">
                                            <input type="file" name="print_logo" class=" btn-primary  form-control-file" >
                                        </div>
                                    </div>
                                </div>
                                <div class="box ">
                                    ...
                                    <div class="row">
                                        ...
                                        <label for="" class="box col-md-4">Edit Admin Logo :</label>
                                        <div class="box col-md-8">
                                            <input type="file" name="admin_logo" class=" btn-primary  form-control-file" >
                                        </div>
                                    </div>
                                </div>
                                <div class="box ">
                                    ...
                                    <div class="row">
                                        ...
                                        <label for="" class="box col-md-4">Edit Admin Small Logo :</label>
                                        <div class="box col-md-8">
                                            <input type="file" name="admin_smalllogo" class=" btn-primary  form-control-file" >
                                        </div>
                                    </div>
                                </div>
                                <div class="box ">
                                    ...
                                    <div class="row">
                                        ...
                                        <label for="" class="box col-md-4">Edit App Logo :</label>
                                        <div class="box col-md-8">
                                            <input type="file" name="app_logo" class=" btn-primary  form-control-file" >
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-md-8">
                                <div class="box  ">
                                    ...
                                    <div class="">
                                        <form action="{{route('new_general_setting')}}"  method="post" enctype="multipart/form-data">
                                            ...
                                            <div class="box-body">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">School Name<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control"  name="school_name" value="BDR">
                                                                <span class="text-danger"></span> <input type="hidden" name="sch_id" value="1">
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">School Code</label>
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control"  name="school_code" value="BDR009">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-10">
                                                                <input type="text" class="form-control" name="address" value="Bangladesh"> <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div><!--./row-->
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" class="form-control"  name="school_phone" value="01712510054"><span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-12">
                                                        ...
                                                        <h4 class="session-head"> Session</h4>
                                                    </div><!--./col-md-12-->
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Session<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                                <select   name="sch_session_id" class="form-control" >
                                                                    ...
                                                                    <option value="15" selected>2020-21</option>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Session Start Month<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Attendance Type</h4>
                                                    </div><!--./col-md-12-->

                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class=" col-sm-6">Attendance:</label>
                                                            <div class="col-sm-6">
                                                                <select name="attendance" required="" class="form-control">
                                                                    <option value="" selected="" disabled="">Select type</option>

                                                                        <option value="0">Day Wise</option>
                                                                        <option value="1">Period Wise</option>
                                                                </select>
                                                               </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-6"> Biometric Attendance: </label>
                                                            <div class="col-sm-6">
                                                                <select name="bio_attendance" required="" class="form-control">
                                                                <option value="" selected="" disabled="">Select type</option>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label class="col-sm-3"> Devices (Separate By Coma) </label>
                                                                <div class="col-sm-9">
                                                                    <input type="text" class="form-control"  name="biometric_device" value="">
                                                                    <span class="text-danger"></span>
                                                                </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Language</h4>
                                                    </div><!--./col-md-12-->

                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Language<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-6">Language RTL Text Mode</label>
                                                            <div class="col-sm-6">
                                                                <select  name="lan_mode" class="form-control" >
                                                                    <option value="">--Select--</option>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Date Time</h4>
                                                    </div><!--./col-md-12-->


                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Date Format<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Timezone<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                                <select  id="language_id" name="sch_timezone" class="form-control" >
                                                                    ...
                                                                    <option value="Africa/Juba"  >(GMT+03:00) Africa, Juba</option>
                                                    ...
                                                    <div class="col-md-4">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Start day of  week<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Currency</h4>
                                                    </div><!--./col-md-12-->
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input id="currency_symbol" name="sch_currency_symbol" placeholder="" type="text" class="form-control" value="TK" />
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12 hidden">
                                                        <div class="form-group row">
                                                            <label class="col-sm-3">Currency Symbol Place<small class="req"> *</small></label>
                                                            <div class="col-sm-9">
                                                                <select  name="currency_place" class="form-control" >
                                                                    <option value="">--Select--</option>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4"> Admission No</label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" name="adm_prefix" id="adm_prefix" class="form-control" value="BDRA">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input type="text" name="adm_start_from" id="adm_start_from" class="form-control" value="00001">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Auto Staff ID</label>
                                                            <div class="col-sm-8">
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                <input id="staffid_prefix" value="BDS" name="staffid_prefix" placeholder="" type="text" class="form-control" />
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-sm-8">
                                                                ...
                                                                <input id="staffid_start_from" value="099" name="staffid_start_from" placeholder="" type="text" class="form-control" />
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Online Examination</h4>
                                                    </div><!--./col-md-12-->

                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Show me only my question</label>
                                                            <div class="col-sm-8">
                                                                <select  name="show_me_question" class="form-control" >
                                                                    <option value="">--Select--</option>
                                                                    <option value="0" selected >Disabled</option>
                                                                    <option value="1"  >Enabled</option>
                                                                </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Miscellaneous</h4>
                                                    </div><!--./col-md-12-->
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4"> Duplicate Fees Invoice</label>
                                                            <div class="col-sm-8">
                                                                <select  name="duplicate_fee" class="form-control" >
                                                                    <option value="">--Select--</option>
                                                                    <option value="0" selected >Disabled</option>
                                                                    <option value="1"  >Enabled</option>
                                                                </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Fees Due Days<small class="req"> *</small></label>
                                                            <div class="col-sm-8">
                                                                <input type="number" name="fee_due_days" id="fee_due_days" class="form-control" value="60">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Online Admission</label>
                                                            <div class="col-sm-8">
                                                                <select  name="online_admission" class="form-control" >
                                                                    <option value="">--Select--</option>
                                                                    <option value="0" selected >Disabled</option>
                                                                    <option value="1"  >Enabled</option>
                                                                </select>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-4">Teacher Restricted Mode</label>
                                                            <div class="col-sm-8">
                                                                <select  name="teacher_rest" class="form-control" >
                                                                    <option value="">--Select--</option>
                                                                    <option value="0" selected >Disabled</option>
                                                                    <option value="1"  >Enabled</option>
                                                                </select>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        ...
                                                        <div class="relative">
                                                            ...
                                                            <h4 class="session-head">Mobile App </h4>
                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="form-group row">
                                                            <label class="col-sm-2"> Mobile App API URL</label>
                                                            <div class="col-sm-10">
                                                                <input type="text" name="mobile_api_url" id="mobile_api_url" class="form-control" value="">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-5"> Mobile App Primary Color Code</label>
                                                            <div class="col-sm-7">
                                                                <input type="text" name="app_primary_color_code" id="app_primary_color_code" class="form-control" value="#424242">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div class="col-md-6">
                                                        <div class="form-group row">
                                                            <label class="col-sm-6"> Mobile App Secondary Color Code</label>
                                                            <div class="col-sm-6">
                                                                <input type="text" name="app_secondary_color_code" id="app_secondary_color_code" class="form-control" value="#eeeeee">
                                                                <span class="text-danger"></span>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="settinghr"></div>
                                                        <h4 class="session-head">Current Theme</h4>
                                                    </div><!--./col-md-12-->
                                                    <div class="col-sm-12">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-sm-3 col-xs-6 col20">
                                                                    <label class="radio-img">
                                                                        <input name="theme" value="white.jpg" type="radio" />
                                                                        <img src="https://www.bdsoft.org/backend/images/white.jpg">
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-3 col-xs-6 col20">
                                                                    <label class="radio-img">
                                                                        <input name="theme" checked  value="default.jpg" type="radio" />
                                                                        <img src="https://www.bdsoft.org/backend/images/default.jpg">
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-3 col-xs-6 col20">
                                                                    <label class="radio-img">
                                                                        <input name="theme"  value="red.jpg" type="radio" />
                                                                        <img src="https://www.bdsoft.org/backend/images/red.jpg">
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-3 col-xs-6 col20">
                                                                    <label class="radio-img">
                                                                        <input name="theme"  value="blue.jpg" type="radio" />
                                                                        <img src="https://www.bdsoft.org/backend/images/blue.jpg">
                                                                    </label>
                                                                </div>
                                                                <div class="col-sm-3 col-xs-6 col20">
                                                                    <label class="radio-img">
                                                                        <input name="theme"  value="gray.jpg" type="radio" />
                                                                        <img src="https://www.bdsoft.org/backend/images/gray.jpg">
                                                                    </label>
                                                                </div>
                                                            </div><!--./row-->
                                            ...
                                            <div class="box-footer">
                                                <input type="submit" class="btn btn-primary " data-loading-text="<i class='fa fa-circle-o-notch fa-spin'></i> Processing"> Save</input>
