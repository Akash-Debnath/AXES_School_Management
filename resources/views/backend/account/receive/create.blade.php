		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Receive Voucher</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
	                ...
	                <form method="post" action="{{ route('account.receivevoucher.store') }}">
	 	                @csrf
					  <div class="row">
						<div class="col-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="voucher_no" class="form-control" value="{{$rev_track}}" readonly> 
						    ...
						    <div class="add_item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            <h5>Receive To <span class="text-danger">*</span></h5>
                                            <div class="controls">
                                    ...
                                    <div class="col-md-4">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <option value="" selected="" disabled="">Select Program</option>
                                                <option value="CU_1">Oli Ullah</option>
                                                {{-- @foreach($classes as $class)
                                                <option value="{{ $class->id }}">{{ $class->name }}</option>
                                                @endforeach	  --}}
                                                </select>
