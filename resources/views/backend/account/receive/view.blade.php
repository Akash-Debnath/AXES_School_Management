	  ...
	  <div class="container-full">
		...
		<section class="content">
                ...
                <td>
                    ...
                    <br><strong>Recept N°:</strong> {{$receive->voucher_no}}
                    <br><strong>Date:</strong>{{date('d-m-Y', strtotime($receive->date))}} 
                </td>
                </tr>
                ...
                <tr>
                    ...
                    <td id="total" style="text-align:right;">@php echo number_format("$receive->amount",2) @endphp</td>
                    
                </tr>
                {{-- <tr>
                    <td id="word_translate" colspan="6"><span style="font-weight: bold;">In Word:</span>{{ NumConvert::word($receive->amount)}} taka only</td>
                </tr> --}}
                <tr>
                    <td colspan="6"><span style="font-weight: bold;">Note:{{$receive->note}} </span></td>
                </tr>
