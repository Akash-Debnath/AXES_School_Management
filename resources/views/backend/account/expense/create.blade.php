		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Expense Voucher</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
	                ...
	                <form method="post" action="{{ route('account.expensevoucher.store') }}">
	 	                @csrf
					  <div class="row">
						<div class="col-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" name="voucher_no" class="form-control" value="{{$exp_track}}" readonly> 
						    ...
						    <div class="add_item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="form-group">
                                            <h5>Expense For<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <select name="exp_for[]" required="" class="form-control">
