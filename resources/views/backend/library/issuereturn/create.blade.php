		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Issue Book</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
	                ...
	                <form method="post" action="{{ route('library.issuereturn.store') }}">
	 	                @csrf
					  <div class="row">
						<div class="col-12">
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group">
                                        <h5>Iusse No<span class="text-danger">*</span></h5>
                                        <div class="controls">
                                            <input type="text" name="invno" class="form-control" value="{{$lb_track}}" readonly> 
						    ...
						    <div class="add_item">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-10">
                                        ...
                                        <div class="form-group">
                                            <h5>Book<span class="text-danger">*</span></h5>
                                            <div class="controls">
                                                <select name="book_id[]" required="" class="form-control">
                                                <option value="" selected="" disabled="">Select One</option>
                                                @foreach($books as $book)
                                                <option value="{{ $book->id }}">{{ $book->book_title }}-{{ $book->isbn_no }}-{{ $book->author }}</option>
                                                @endforeach	 
                                                </select>
                                            </div>
                                        </div> <!-- // end form group -->
