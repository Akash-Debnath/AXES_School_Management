...
<section class="content">
	 ...
	 <form method="post" action="{{ route('update.teacher.registration',$editData->teacher_id) }}" enctype="multipart/form-data">
	 	@csrf
		...
		<div class="controls">
	 <input type="text" name="name" class="form-control" required="" value="{{ $editData['teacher']['name'] }}"> 
	  </div>		 
	  </div>
 ...
 <option value="Male" {{ ($editData['teacher']['gender'] == 'Male')? 'selected':'' }}>Male</option>
 <option value="Female" {{ ($editData['teacher']['gender'] == 'Female')? 'selected':'' }}>Female</option>
 ...
 <option value="Islam"{{ ($editData['teacher']['religion'] == 'Islam')? 'selected':'' }}>Islam</option>
 <option value="Hindu"{{ ($editData['teacher']['religion'] == 'Hindu')? 'selected':'' }}>Hindu</option>
 <option value="Christan"{{ ($editData['teacher']['religion'] == 'Christan')? 'selected':'' }}>Christan</option>
	...
	<div class="row"> <!-- 2nd Row -->
		...
		<div class="controls">
	 <input type="text" name="mobile" class="form-control" required="" value="{{ $editData['teacher']['mobile'] }}" > 
	  </div>		 
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="text" name="address" class="form-control" required="" value="{{ $editData['teacher']['address'] }}" > 
	  </div>		 
	  </div>
	...
	<div class="col-md-4">
		...
		<div class="controls">
	 <input type="date" name="dob" class="form-control" required="" value="{{ $editData['teacher']['dob'] }}" > 
	  </div>		 
	  </div>
...
<div class="row"> <!-- 3rd Row -->
		...
		<div class="controls">
	 <input type="email" name="email" class="form-control" required="" value="{{ $editData['teacher']['dob'] }}" > 
	  </div>		 
	  </div>
