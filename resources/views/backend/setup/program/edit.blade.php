                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" action="{{ route('update.program',$editData->id) }}" enctype="multipart/form-data">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select name="did" required="" class="form-control">
                                                        ...
                                                        <option value="{{ $department->id }}" @if($department->id==$editData->fid) Selected @endif>{{ $department->name}} </option>  
