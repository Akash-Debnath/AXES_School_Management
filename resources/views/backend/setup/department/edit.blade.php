                    ...
                    <div class="box">
                        ...
                        <div class="row">
                            <div class="col">
                                ...
                                <form method="post" action="{{ route('update.department',$editData->id) }}" enctype="multipart/form-data">
                                    @csrf
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                        ...
                                                        <option value="{{ $faculty->id }}" @if($faculty->id==$editData->fid) Selected @endif>{{ $faculty->name }}</option>
                                                        @endforeach	 
                                                        </select>
                                                    </div>
                                                </div> <!-- // end form group -->
                                        ...
                                        <div class="row"> <!-- 1st Row -->
                                            ...
                                            <div class="row"> <!-- 5TH Row -->
                                                    ...
                                                    <div class="col-md-5">
                                                        ...
                                                        <div class="form-group">
                                                            <div class="controls">
                                                                <img id="showImage1" src="{{url('public/upload/department/',$editData->image) }}" style="width: 100px; width: 100px; border: 1px solid #000000;">
