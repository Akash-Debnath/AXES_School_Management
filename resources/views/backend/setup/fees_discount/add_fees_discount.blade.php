		 ...
		 <!-- Basic Forms -->
		  <div class="box">
			<div class="box-header with-border">
			  <h4 class="box-title">Add Fees Discount</h4>
			...
			<div class="box-body">
			  <div class="row">
				<div class="col">
					...
					<form method="post" action="{{ route('store.fees.discount') }}" enctype="multipart/form-data">
						@csrf 
					  <div class="row">
						<div class="col-12">	
							...
							<div class="row"> <!-- 9th Row -->
									...
									<div class="col-md-4">
										...
										<div class="form-group">
											<h5>Discount code<span class="text-danger">*</span></h5>
											<div class="controls">
