	...
	@if($search=='')					
	 <table id="example1" class="table table-bordered table-striped">
		...
		<tbody>
			...
			<tr>
				<td>{{ $key+1 }}</td>
				<td><a href="{{ route('student.registration.view_profile',$value->student_id) }}" > {{ $value['student']['name'] }}</a></td>
				...
				<td>
	 				<img src="{{ (!empty($value['student']['image']))? url('public/upload/student_images/'.$value['student']['image']):url('public/upload/no_image.jpg') }}" style="width: 60px; width: 60px;"> 
				</td>				 
				<td>
                    ...
                    <a title="Delete" href="{{ route('student.registration.delete',$value->student_id) }}" class="btn btn-danger"> <i class="fa fa-trash"></i> </a>
				</td>
	  ...
	  <table id="example1" class="table table-bordered table-striped">
		...
		<tbody>
			...
			<tr>
				...
				<td>  {{ $value['department']['name'] }}</td>	
				<td>
	 				<img src="{{ (!empty($value['student']['image']))? url('public/upload/student_images/'.$value['student']['image']):url('upload/no_image.jpg') }}" style="width: 60px; width: 60px;"> 
				</td>				 
				<td>
					<a title="Edit" href="{{ route('student.registration.edit',$value->student_id) }}" class="btn btn-info"> <i class="fa fa-edit"></i> </a>
