        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h4 class="box-title">Add Postal Dispatch</h4>                 
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                                                
							<form method="post" action="{{ route('store.postaldispatch') }}" enctype="multipart/form-data">
								@csrf 
								<div class="row">
								    <div class="col-12">
										...
										<div class="row">
									        <div class="col-md-6">
									               ...
									               <div class="controls">
									            	   <input type="text" name="from_title" class="form-control" required="" >            	</div>		 
									               </div>
