        ...
        <section class="content">
            ...
            <div class="box">
                <div class="box-header with-border">
                  <h4 class="box-title">Edit Postal Receive</h4>                 
                </div>
                <div class="box-body">
                    <div class="row">
                        <div class="col">
                                                
                             <form method="post" action="{{ route('update.postalreceive',$editData->id) }}" enctype="multipart/form-data">
                             	@csrf 
                                <div class="row">
                                	<div class="col-12">
                                        ...
                                        <div class="row">        
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                    <input type="text" name="from_title" class="form-control" required="" value={{$editData->from_title}}>			
										    		</div>		 
                                                </div>
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                	<input type="text" name="reference_no" class="form-control" required=""value={{$editData->reference_no}} >      
											     	</div>		 
                                                </div>
										...
										<div class="row">     
                                            ...
                                            <div class="col-md-6">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <div class="controls">
                                                	<input type="text" name="note" class="form-control" required=""value={{$editData->note}} >            	</div>		 
                                                </div>
