...
<section class="content">
         ...
         <!-- Basic Forms -->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">COMPLAINTCOM</h4>
     ...
     <form method="post" action="{{ route('complaintcom.update',$complaintcom->id) }}"enctype="multipart/form-data">
        @csrf
            ...
            <div class="row"> <!-- 1st Row -->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                                <input type="text" name="name" class="form-control" required="" value="{{ $complaintcom->name }}">
                        </div>
                    </div>
