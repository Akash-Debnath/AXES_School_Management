...
<section class="content">
     ...
     <form method="post" action="{{ route('bot.update',$bot->id) }}"enctype="multipart/form-data">
        @csrf
        @method('PUT')
                      <div class="row">
                        <div class="col-12">
            ...
            <div class="row"> <!-- 1st Row -->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                                <input type="text" name="name" class="form-control" required="" value="{{ $bot->name }}">
                        </div>
                    </div>
