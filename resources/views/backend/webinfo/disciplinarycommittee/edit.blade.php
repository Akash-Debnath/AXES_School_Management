...
<section class="content">
         ...
         <!-- Basic Forms -->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">DISCIPLINARYCOM</h4>
     ...
     <form method="POST" action="{{ route('disciplinarycommittee.update',$disciplinarycom->id) }}"enctype="multipart/form-data">
        @csrf
        @method('PUT')
                      <div class="row">
                        <div class="col-12">
            ...
            <div class="row"> <!-- 1st Row -->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                                <input type="text" name="name" class="form-control" required="" value="{{ $disciplinarycom->name }}">
                        </div>
                    </div>
