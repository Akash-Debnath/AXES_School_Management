...
<section class="content">
     ...
     <form method="POST" action="{{ route('dean.update',$dean->id) }}"enctype="multipart/form-data">
        @csrf
            ...
            <div class="row"> <!-- 1st Row -->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                                <input type="text" name="name" class="form-control" required="" value="{{ $dean->name }}">
                        </div>
                    </div>
