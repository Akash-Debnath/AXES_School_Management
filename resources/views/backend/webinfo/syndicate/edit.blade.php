...
<section class="content">
         ...
         <!-- Basic Forms -->
          <div class="box">
            <div class="box-header with-border">
              <h4 class="box-title">SYNDICATE</h4>
     ...
     <form method="post" action="{{ route('syndicate.update',$syndicate->id) }}"enctype="multipart/form-data">
        @csrf
        @method('PUT')
                      <div class="row">
                        <div class="col-12">
            ...
            <div class="row"> <!-- 1st Row -->
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <div class="controls">
                                <input type="text" name="name" class="form-control" required="" value="{{ $syndicate->name }}">
                        </div>
                    </div>
